    ...
    <div className={`bg-white px-3 pt-3 ${errorTextVisible ? "pb-6" : "pb-3"}`}>
      <div className="relative bg-inherit">
        <input
          ...
          id={id}
          name={name}
          className="peer bg-transparent h-8 w-full rounded-sm text-gray-800 placeholder-transparent ring-2 px-2 ring-gray-040 focus:ring-primary focus:outline-none"
